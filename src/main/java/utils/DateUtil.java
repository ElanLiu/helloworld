...
import com.mycompany.practice.DateToString;
...
public class DateUtil {
	 ...
	 * getTimeInstance、getDateInstance 或 getDateTimeInstance 来创建日期-时间格式器。
	 * 每一个这样的类方法都能够返回一个以默认格式模式初始化的日期/时间格式器。 可以根据需要使用 applyPattern 方法来修改格式模式。
	 * 
	 * @param date
	 * @param pattern
